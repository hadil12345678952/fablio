...
import { ArrowLeft, Quote, Sparkles, Volume2, Rabbit, Bird, Turtle } from "lucide-react";
import { db } from "@/db";
    ...
    <div className="space-y-8">
      ...
      <article className="carte anim-apparition overflow-hidden" style={{ animationDelay: "0.06s" }}>
        ...
        <div className="p-6 sm:p-10">
          {fable.audioUrl && (
            <div className="mb-6 flex flex-wrap items-center gap-3 rounded-2xl bg-ciel/10 px-5 py-4">
              <Volume2 className="size-6 text-ciel" />
              <div className="min-w-0 flex-1">
                <p className="font-titre font-bold">Écoute la fable</p>
